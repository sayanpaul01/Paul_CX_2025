...
# Create the single-column CX vs. DOX correlation heatmap
ggplot(heatmap_data_long, aes(x = Comparison, y = CX_Sample, fill = value)) +
  ...
  geom_text(aes(label = round(value, 3)), color = "black", size = 5, fontface = "bold") +  # Display r-values
  labs(x = "", y = "CX Samples", fill = "Correlation (r)", 
