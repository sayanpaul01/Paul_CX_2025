...
Entrez_IDs <- c(
  ...
  5888, 5893, 5925, 595, 5916, 5981, 6118, 637, 672, 7157, 7799, 8243, 836, 841, 84126, 842, 8795, 891, 894, 896, 898, 9133, 9134, 983, 9874, 993, 995
)
...
heatmap <- Heatmap(logFC_matrix, name = "logFC", top_annotation = ha_top,
                   ...
                   column_title = "DNA damage response gene expression in\nCX5461 and DOX treated samples",
