...
## **📌 Corrmotif Model CX 0.1 (3hr, 24hr and 48hr)**
## Load Corrmotif Data
...
## **📌 Corrmotif Model CX 0.1 (3hr, 24hr and 48hr) (K=1:8)**
```{r Model_CX_0.1_1, eval=FALSE,echo=TRUE, message=FALSE}
set.seed(11111)
...
## **📌 Plot motif CX 0.1 (3hr, 24hr and 48hr)**
```{r Model_CX_0.1, echo=TRUE, message=FALSE}
...
```{r pie-chart_CX_0.1, echo=TRUE, message=FALSE, warning=FALSE}
...
## **📌 Corrmotif Model CX 0.5 (3hr, 24hr and 48hr)**
## Load Corrmotif Data
```{r load_data1, echo=TRUE, results='hide', message=FALSE}
# Read the Corrmotif Results
Corrmotif <- read.csv("data/Corrmotif/CX5461.csv")
Corrmotif_df <- data.frame(Corrmotif)
rownames(Corrmotif_df) <- Corrmotif_df$Gene
...
## **📌 Corrmotif Model CX 0.5 (3hr, 24hr and 48hr) (K=1:8)**
```{r Model2, eval=FALSE, echo=TRUE, message=FALSE}
set.seed(11111)
...
## **📌 Plot motif CX 0.5 (3hr, 24hr and 48hr)**
```{r Model_CX_0.5, echo=TRUE, message=FALSE}
...
```{r pie-chart_CX_0.5, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r Prob4, echo=TRUE, message=FALSE}
# Extract posterior probabilities for genes
...
## **📌 Corrmotif Model DOX 0.1 (3hr, 24hr and 48hr)**
## Load Corrmotif Data
```{r load_data_DOX 0.1, echo=TRUE, results='hide', message=FALSE}
# Read the Corrmotif Results
Corrmotif <- read.csv("data/Corrmotif/CX5461.csv")
Corrmotif_df <- data.frame(Corrmotif)
rownames(Corrmotif_df) <- Corrmotif_df$Gene
...
## **📌 Corrmotif Model DOX 0.1 (3hr, 24hr and 48hr) (K=1:8)**
...
## **📌 Plot motif DOX 0.1 (3hr, 24hr and 48hr)**
```{r Model_DOX_0.1, echo=TRUE, message=FALSE}
...
```{r pie-chart_DOX_0.1, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r Prob10, echo=TRUE, message=FALSE}
# Extract posterior probabilities for genes
...
## **📌 Corrmotif Model DOX 0.5 (3hr, 24hr and 48hr)**
## Load Corrmotif Data
```{r load_data5, echo=TRUE, results='hide', message=FALSE}
# Read the Corrmotif Results
Corrmotif <- read.csv("data/Corrmotif/CX5461.csv")
Corrmotif_df <- data.frame(Corrmotif)
rownames(Corrmotif_df) <- Corrmotif_df$Gene
...
## **📌 Corrmotif Model DOX 0.5 (3hr, 24hr and 48hr) (K=1:8)**
```{r Model7, eval=FALSE, echo=TRUE, message=FALSE}
set.seed(11111)
...
## **📌 Plot motif DOX 0.1 (3hr, 24hr and 48hr)**
```{r Model_DOX_0.5, echo=TRUE, message=FALSE}
...
```{r pie-chart_DOX_0.5, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r box_final, echo=TRUE, results='hide',message=FALSE, warning=FALSE}
...
## **📌 Absolute logFC Boxplot (CX response groups) **
```{r abs logFC, echo=TRUE, message=FALSE, warning=FALSE, fig.width=10,fig.height=8}
# Load required libraries
library(dplyr)
library(ggplot2)
...
ggplot(CX_toptables, aes(x = Timepoint, y = absFC, fill = Category)) +
  ...
  labs(
    x = "Timepoints",
    y = "|Log Fold Change|",
    title = "|Log Fold Change| boxplots across response groups"
  ) +
  theme(
...
```{r abs logFC DOX, echo=TRUE, message=FALSE, warning=FALSE, fig.width=10,fig.height=8}
# Load required libraries
library(dplyr)
library(ggplot2)
...
```{r logFC CX, echo=TRUE, message=FALSE, warning=FALSE, fig.width=10,fig.height=8}
# Load required libraries
library(dplyr)
library(ggplot2)
...
```{r logFC DOX, echo=TRUE, message=FALSE, warning=FALSE, fig.width=10,fig.height=8}
# Load required libraries
library(dplyr)
library(ggplot2)
...
```{r Mean CX, echo=TRUE, message=FALSE, warning=FALSE, fig.width=8,fig.height=6}
# Load required libraries
# Load required libraries
library(dplyr)
library(ggplot2)
...
```{r Mean DOX, echo=TRUE, message=FALSE, warning=FALSE, fig.width=8,fig.height=6}
# Load required libraries
library(dplyr)
library(ggplot2)
...
```{r Mean CX2, echo=TRUE, message=FALSE, warning=FALSE, fig.width=8,fig.height=6}
# Load required libraries
# Load required libraries
library(dplyr)
library(ggplot2)
...
```{r Mean DOX2, echo=TRUE, message=FALSE, warning=FALSE, fig.width=8,fig.height=6}
