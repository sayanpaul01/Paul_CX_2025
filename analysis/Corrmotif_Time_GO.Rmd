---
title: "Function and Pathway Enrichment Analysis of Corrmotifs (Timepoints)"
...
prob_CX_1_0.1 <- read.csv("data/prob_CX_1_0.1.csv")$Entrez_ID
prob_CX_2_0.1 <- read.csv("data/prob_CX_2_0.1.csv")$Entrez_ID
prob_CX_1_0.5 <- read.csv("data/prob_CX_1_0.5.csv")$Entrez_ID
prob_CX_2_0.5 <- read.csv("data/prob_CX_2_0.5.csv")$Entrez_ID
prob_DOX_1_0.1 <- read.csv("data/prob_DOX_1_0.1.csv")$Entrez_ID
prob_DOX_2_0.1 <- read.csv("data/prob_DOX_2_0.1.csv")$Entrez_ID
prob_DOX_1_0.5 <- read.csv("data/prob_DOX_1_0.5.csv")$Entrez_ID
prob_DOX_2_0.5 <- read.csv("data/prob_DOX_2_0.5.csv")$Entrez_ID
...
```{r GO, echo=TRUE, message=FALSE, fig.width=12, fig.height=12}
# Perform GO enrichment analysis for BP, MF, and CC
go_enrichment_BP <- enrichGO(gene = prob_CX_1_0.1,
                             OrgDb = org.Hs.eg.db,
                             keyType = "ENTREZID",
                             universe = background,
                             ont = "BP",
...
go_enrichment_MF <- enrichGO(gene = prob_CX_1_0.1,
                             OrgDb = org.Hs.eg.db,
                             keyType = "ENTREZID",
                             universe = background,
                             ont = "MF",
...
go_enrichment_CC <- enrichGO(gene = prob_CX_1_0.1,
                             OrgDb = org.Hs.eg.db,
                             keyType = "ENTREZID",
                             universe = background,
                             ont = "CC",
...
gost_results <- gost(
  query = prob_CX_1_0.1,           # List of input genes (prob_all_1)
...
# Perform GO enrichment analysis for BP, MF, and CC
go_enrichment_BP <- enrichGO(gene = prob_CX_2_0.1,
                             OrgDb = org.Hs.eg.db,
                             keyType = "ENTREZID",
                             universe = background,
                             ont = "BP",
...
go_enrichment_MF <- enrichGO(gene = prob_CX_2_0.1,
                             OrgDb = org.Hs.eg.db,
                             keyType = "ENTREZID",
                             universe = background,
                             ont = "MF",
...
go_enrichment_CC <- enrichGO(gene = prob_CX_2_0.1,
                             OrgDb = org.Hs.eg.db,
                             keyType = "ENTREZID",
                             universe = background,
                             ont = "CC",
...
# Perform GO enrichment analysis with gprofiler2
gost_results <- gost(
  query = prob_CX_2_0.1,           # List of input genes (prob_all_1)
  organism = "hsapiens",   # Human organism
  user_threshold = 0.05,   # Adjusted p-value cutoff
  correction_method = "fdr", # Multiple testing correction
  domain_scope = "custom", # Use custom background
...
## **📌 CX_high_non-response**
## **📌 GO Enrichment Clusterprofiler**
```{r GO3, echo=TRUE, message=FALSE, fig.width=12, fig.height=12}
# Perform GO enrichment analysis for BP, MF, and CC
go_enrichment_BP <- enrichGO(gene = prob_CX_1_0.5,
                             OrgDb = org.Hs.eg.db,
                             keyType = "ENTREZID",
                             universe = background,
                             ont = "BP",
...
go_enrichment_MF <- enrichGO(gene = prob_CX_1_0.5,
                             OrgDb = org.Hs.eg.db,
                             keyType = "ENTREZID",
                             universe = background,
                             ont = "MF",
...
go_enrichment_CC <- enrichGO(gene = prob_CX_1_0.5,
                             OrgDb = org.Hs.eg.db,
                             keyType = "ENTREZID",
                             universe = background,
                             ont = "CC",
...
# Perform GO enrichment analysis with gprofiler2
gost_results <- gost(
  query = prob_CX_1_0.5,           # List of input genes (prob_all_1)
  organism = "hsapiens",   # Human organism
  user_threshold = 0.05,   # Adjusted p-value cutoff
  correction_method = "fdr", # Multiple testing correction
  domain_scope = "custom", # Use custom background
...
# Perform GO enrichment analysis for BP, MF, and CC
go_enrichment_BP <- enrichGO(gene = prob_CX_2_0.5,
                             OrgDb = org.Hs.eg.db,
                             keyType = "ENTREZID",
                             universe = background,
                             ont = "BP",
...
go_enrichment_MF <- enrichGO(gene = prob_CX_2_0.5,
                             OrgDb = org.Hs.eg.db,
                             keyType = "ENTREZID",
                             universe = background,
                             ont = "MF",
...
go_enrichment_CC <- enrichGO(gene = prob_CX_2_0.5,
                             OrgDb = org.Hs.eg.db,
                             keyType = "ENTREZID",
                             universe = background,
                             ont = "CC",
...
# Perform GO enrichment analysis with gprofiler2
gost_results <- gost(
  query = prob_CX_2_0.5,           # List of input genes (prob_all_1)
  organism = "hsapiens",   # Human organism
  user_threshold = 0.05,   # Adjusted p-value cutoff
  correction_method = "fdr", # Multiple testing correction
  domain_scope = "custom", # Use custom background
...
## **📌 DOX_low_Non-response**
## **📌 GO Enrichment Clusterprofiler**
```{r GO5, echo=TRUE, message=FALSE, fig.width=12, fig.height=12}
# Perform GO enrichment analysis for BP, MF, and CC
go_enrichment_BP <- enrichGO(gene = prob_DOX_1_0.1,
                             OrgDb = org.Hs.eg.db,
                             keyType = "ENTREZID",
                             universe = background,
                             ont = "BP",
...
go_enrichment_MF <- enrichGO(gene = prob_DOX_1_0.1,
                             OrgDb = org.Hs.eg.db,
                             keyType = "ENTREZID",
                             universe = background,
                             ont = "MF",
...
go_enrichment_CC <- enrichGO(gene = prob_DOX_1_0.1,
                             OrgDb = org.Hs.eg.db,
                             keyType = "ENTREZID",
                             universe = background,
                             ont = "CC",
...
# Perform GO enrichment analysis with gprofiler2
gost_results <- gost(
  query = prob_DOX_1_0.1,           # List of input genes (prob_all_1)
  organism = "hsapiens",   # Human organism
  user_threshold = 0.05,   # Adjusted p-value cutoff
  correction_method = "fdr", # Multiple testing correction
  domain_scope = "custom", # Use custom background
...
# Perform GO enrichment analysis for BP, MF, and CC
go_enrichment_BP <- enrichGO(gene = prob_DOX_2_0.1,
                             OrgDb = org.Hs.eg.db,
                             keyType = "ENTREZID",
                             universe = background,
                             ont = "BP",
...
go_enrichment_MF <- enrichGO(gene = prob_DOX_2_0.1,
                             OrgDb = org.Hs.eg.db,
                             keyType = "ENTREZID",
                             universe = background,
                             ont = "MF",
...
go_enrichment_CC <- enrichGO(gene = prob_DOX_2_0.1,
                             OrgDb = org.Hs.eg.db,
                             keyType = "ENTREZID",
                             universe = background,
                             ont = "CC",
...
# Perform GO enrichment analysis with gprofiler2
gost_results <- gost(
  query = prob_DOX_2_0.1,           # List of input genes (prob_all_1)
  organism = "hsapiens",   # Human organism
  user_threshold = 0.05,   # Adjusted p-value cutoff
  correction_method = "fdr", # Multiple testing correction
  domain_scope = "custom", # Use custom background
...
## **📌 DOX_high_Non-response**
## **📌 GO Enrichment Clusterprofiler**
```{r GO7, echo=TRUE, message=FALSE, fig.width=12, fig.height=12}
# Perform GO enrichment analysis for BP, MF, and CC
go_enrichment_BP <- enrichGO(gene = prob_DOX_1_0.5,
                             OrgDb = org.Hs.eg.db,
                             keyType = "ENTREZID",
                             universe = background,
                             ont = "BP",
...
go_enrichment_MF <- enrichGO(gene = prob_DOX_1_0.5,
                             OrgDb = org.Hs.eg.db,
                             keyType = "ENTREZID",
                             universe = background,
                             ont = "MF",
...
go_enrichment_CC <- enrichGO(gene = prob_DOX_1_0.5,
                             OrgDb = org.Hs.eg.db,
                             keyType = "ENTREZID",
                             universe = background,
                             ont = "CC",
...
# Perform GO enrichment analysis with gprofiler2
gost_results <- gost(
  query = prob_DOX_1_0.5,           # List of input genes (prob_all_1)
  organism = "hsapiens",   # Human organism
  user_threshold = 0.05,   # Adjusted p-value cutoff
  correction_method = "fdr", # Multiple testing correction
  domain_scope = "custom", # Use custom background
...
## **📌 DOX_high_mid_late_response**
## **📌 GO Enrichment Clusterprofiler**
```{r GO8, echo=TRUE, message=FALSE, fig.width=12, fig.height=12}
# Perform GO enrichment analysis for BP, MF, and CC
go_enrichment_BP <- enrichGO(gene = prob_DOX_2_0.5,
                             OrgDb = org.Hs.eg.db,
                             keyType = "ENTREZID",
                             universe = background,
                             ont = "BP",
...
go_enrichment_MF <- enrichGO(gene = prob_DOX_2_0.5,
                             OrgDb = org.Hs.eg.db,
                             keyType = "ENTREZID",
                             universe = background,
                             ont = "MF",
...
go_enrichment_CC <- enrichGO(gene = prob_DOX_2_0.5,
                             OrgDb = org.Hs.eg.db,
                             keyType = "ENTREZID",
                             universe = background,
                             ont = "CC",
...
# Perform GO enrichment analysis with gprofiler2
gost_results <- gost(
  query = prob_DOX_2_0.5,           # List of input genes (prob_all_1)
  organism = "hsapiens",   # Human organism
  user_threshold = 0.05,   # Adjusted p-value cutoff
  correction_method = "fdr", # Multiple testing correction
  domain_scope = "custom", # Use custom background
