...
Entrez_IDs <- c(
  ...
  150383,79730,344595,6251,3482,23262,9588,87769,23409,339416,
  7292,55157,720,5066,3107,54535,1590,80059,7991,57110,
  8803,9620,323,54826,5916,23371,283337,64078,80010,1933,
  10818,51020
)
...
```{r Data_prep, echo=TRUE, message=FALSE, fig.height=14, fig.width=10}
